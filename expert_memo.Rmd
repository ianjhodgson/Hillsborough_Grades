...
school_grades <- read_csv('data/schoolgrades23_linked.csv') %>% 
  ...
  ## SENSITIVITY CHECK
  mutate(informational_baseline_grade_2023 = ifelse(informational_baseline_grade_2023 %in% c("D", "F"), "D/F", informational_baseline_grade_2023),
...
sesir_2122_analysis %>% 
  ...
  summarise(fights = mean(fights),
            fights_percap = mean(incidents_per_cap))
