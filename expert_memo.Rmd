...
-   Pull census data for Black and Hispanic school-aged children by zoned school.
...
NOTE: Student discipline data is from the 2021-22 school year. Data for the 2022-23 school year is expected later this month.
...
absent %>% 
  group_by(Grade) %>% 
  summarise(mean_absent_10_pct = mean(percent_of_students_absent_10_percent_or_more, na.rm = T),
            mean_absent_21_days = mean(percent_of_students_absent_21_or_more_days, na.rm = T))
...
Hillsborough district schools are required to inform parents when a teacher was covering a class they were not certified to teach.
